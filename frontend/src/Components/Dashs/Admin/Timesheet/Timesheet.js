        ...
        { 
            ...
            valueGetter: p => {
                ...
                if (startDate > currentDate) {
                    ...
                    let startFormattedTime = startDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: true });
                    let endFormattedTime = endDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: true });
